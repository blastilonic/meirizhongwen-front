...
@Component({
  selector: 'app-tingli-xines',
  templateUrl: './tingli-xines.component.html',
  styleUrls: ['./tingli-xines.component.css']
})
export class TingliXinesComponent implements OnInit {
  ...
  next() {
    this.router.navigate(['/games/tinglixines/' + this.activatedRouter.snapshot.params.id]);
    this.correcte = false;
    this.incorrecte = 0;
    this.ngOnInit();
  }
