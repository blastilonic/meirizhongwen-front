...
@Component({
  selector: 'app-xines-catala',
  templateUrl: './xines-catala.component.html',
  styleUrls: ['./xines-catala.component.css']
})
export class XinesCatalaComponent implements OnInit {
  ...
  next() {
    this.router.navigate(['/games/xinescatala/' + this.activatedRouter.snapshot.params.id]);
    this.correcte = false;
    this.incorrecte = 0;
    this.ngOnInit();
  }
