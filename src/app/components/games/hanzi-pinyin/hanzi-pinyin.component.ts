...
@Component({
  ...
  templateUrl: './hanzi-pinyin.component.html',
  styleUrls: ['./hanzi-pinyin.component.css']
})
export class HanziPinyinComponent implements OnInit {
  ...
  next() {
    this.router.navigate(['/games/hanzipinyin/' + this.activatedRouter.snapshot.params.id]);
    this.correcte = false;
    this.incorrecte = 0;
    this.ngOnInit();
  }
